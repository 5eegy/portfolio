    ...
    >
      ...
      >
        ...
        <p className="mt-8 text-center text-white text-xs font-neue">
          ...
          <span className="text-white opacity-50">SEGY</span>{" "}
      ...
      >
        {`Hi, I'm Segy, a software developer with 2-years experience Passionate about building visually stunning and user-friendly web applications fromscratch. I excel in HTML, CSS, and JavaScript, and am well-versed in frameworks and technologies like Typescript, Firebase, Redux, React, and Nextjs. I have experience with responsive design, cross-browser
