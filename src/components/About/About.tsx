...
const About = () => {
  return (
    <div className="mt-4  border-b border-t pb-8">
      ...
      <motion.p className="w-[95%]  h-[170px] bg-red-400 m-auto mt-12"
      initial={{
        opacity: 0,
        width: 0,
        height: 0
      ...
      className="block p-[1px] text-xs mt-5 mx-3 w-24 rounded-lg bg-gradient-to-r duration-400 from-pink-400 via-red-400 to-yellow-400 hover:to-pink-400 hover:from-red-400 hover:via-yellow-400 hover:shadow-md hover:shadow-yellow-400">
        <a
